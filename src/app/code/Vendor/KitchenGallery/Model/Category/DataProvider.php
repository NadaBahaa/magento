<?php
namespace Vendor\KitchenGallery\Model\Category;
...
class DataProvider extends AbstractDataProvider
{
    ...
    public function getData()
    {
        ...
        if ($model) {
            ...
            $data = $this->dataPersistor->get('vendor_kitchengallery_category');
            if (!empty($data)) {
                ...
                $this->dataPersistor->clear('vendor_kitchengallery_category');
            } else {
